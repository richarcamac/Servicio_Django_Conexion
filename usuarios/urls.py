...
from .views import ProductoViewSet, RegistrarProductoAPIView, ListarProductosAPIView, UploadImagenAPIView
...
urlpatterns = [
    ...
    path('api/upload_imagen/', UploadImagenAPIView.as_view(), name='upload_imagen'),
